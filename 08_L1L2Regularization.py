#regularization methods reduce generilization error. L1 and L2 
#L1 reg penalty is the sum all absolute values for the weights and biases
#L2 reg penalty is the sum of squared weights and biases 
